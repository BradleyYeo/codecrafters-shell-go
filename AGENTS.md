...
- Follow John Ousterhout, Jimmy Koppel and Daniel Jackson software design principles.
...
- Add a small, to the point, comment to explain *what* the block does and *why*. Use examples when possible. Propose ASCII drawings to explain complete systems. Add comments for what is expected input and output of a function for clarity.
